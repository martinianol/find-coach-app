<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control" :class="{invalid: !description.isValid}">
      ...
      <p v-if="!description.isValid">Please provide a description</p>
    </div>
    <div class="form-control" :class="{invalid: !rate.isValid}">
      <label for="rate">Hourly rate</label>
      <input type="number" id="rate" v-model.number="rate.val" @blur="clearValidity('rate')"/>
      <p v-if="!rate.isValid">Please provide a positive number</p>
    </div>
    <div class="form-control" :class="{invalid: !areas.isValid}">
     ...
     <div>
       <input type="checkbox" id="frontend" value="career" v-model="areas.val" @blur="clearValidity('areas')" />
       <label for="career">Career Advisory</label>
     </div>
     <p v-if="!areas.isValid">Please select at least one option</p>
    </div>
...
export default {
  ...
  methods: {
    ...
    validateForm() {
      ...
      const textFields = [this.firstName, this.lastName, this.description]
